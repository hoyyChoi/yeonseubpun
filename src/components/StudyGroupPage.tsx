...
import { Users, Trophy, Target, Calendar, Crown, Medal, Award, Plus, Search } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">함께 성장하는 개발자들과 경쟁하고 학습하세요</p>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card className="border-0 shadow-lg">
              ...
              <CardContent className="space-y-4">
                {myGroups.map((group) => (
                  <div key={group.id} className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
